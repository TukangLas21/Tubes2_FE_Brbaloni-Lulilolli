...
const Home: React.FC = () => {
    return (
        <div className='flex flex-col items-center justify-center mt-32 pb-16'>
            <Navbar />

            <div className='flex flex-col items-center justify-center mt-4 pr-8 pl-8 pt-12 pb-8 bg-white
